...
public class AlumnoDTO {
    ...
    // Corregido para que sea String y valide correctamente con @Pattern
    ...
    // Cambiado a @NotNull y ajustado el mensaje
    ...
    @NotNull(message = "El campo carrera no debe ser nulo")
